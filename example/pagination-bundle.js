...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pagination = _vue2.default.extend({
	    props: {
	        currentPage: {
	            type: Number,
	    ...
	    computed: {
	        ...
	        pages: function pages() {
	            ...
	            var _getInterval = getInterval(this.currentPage, this.first, this.last, this.displayNum);

	            var begin = _getInterval.begin;
	            var to = _getInterval.to;
	    ...
	    methods: {
	        make_page_item: function make_page_item(pageNo) {
	            var obj = {
	                name: pageNo,
	                value: pageNo,
	                url: this.url,
	            ...
	            return _lodash2.default.extend({}, PAGE_ITEM, obj);
	        },
	        prev: function prev() {
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"pagination\">\n    <ul>\n        <li><a class=\"ui button\" v-on:click=\"prev()\" v-bind:class=\"{'disabled': isFirst }\">Prev</a></li>\n        <li v-for=\"page in pages\"><a :href=\"page.url\" v-on:click=\"go(page.value)\" class=\"ui button\" :class=\"{'active': page.active}\">{{page.name}}</a></li>\n        <li><a class=\"ui button\" v-on:click=\"next()\" v-bind:class=\"{'disabled': isLast }\">Next</a></li>\n    </ul>\n</div>'\n";
